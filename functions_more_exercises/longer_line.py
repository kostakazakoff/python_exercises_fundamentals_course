...
def longer_line(l1_x1, l1_y1, l1_x2, l1_y2, l2_x1, l2_y1, l2_x2, l2_y2):
    ...
    l1_p1_output = tuple(math.floor(x) for x in line_1[0])
    l1_p2_output = tuple(math.floor(x) for x in line_1[1])
    ...
    l2_p1_output = tuple(math.floor(x) for x in line_2[0])
    l2_p2_output = tuple(math.floor(x) for x in line_2[1])

    if l2_length > l1_length:
        output = str(l2_p1_output) + '' + str(l2_p2_output)
    else:
        output = str(l1_p1_output) + '' + str(l1_p2_output)
